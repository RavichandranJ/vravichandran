package com.vravichandran.cms.mediator.renderer.song
{
	...
	public class Singer1IRendererMediator extends AbstractMediator
	{
		
		[Inject]
		public var view:Singer1IRenderer;
		...
		override public function initialize():void
		{
			...
			view.cb.selectedIndex = view.data ? SongVO(view.data).singer1Index : -1;
		...
		{
			if(view.cb.selectedItem && view.data.singer1 != view.cb.selectedItem.artist_id)
			{
				view.data.singer1 = view.cb.selectedItem.artist_id;
				view.data.isDirty = true;
				view.data.singer1Index = event.newIndex;
			}				
		}		
